...
void loop() {
  ...
  //  float in_volt1 = o2_value1 * 3.9 / 4096.0;
  //  float in_volt1 = (o2_value1 + 161) / 1260.0;
  float in_volt1 = (o2_value1 + 161) / 1230.0;
  float in_volt2 = (o2_value2 + 161) / 1230.0;
  ...
  Serial.print( "," );
  Serial.println ( serial_out_volt2 );
